...
void loop(){
  ...
  if(tubo.isPressed()){
      ...
      switch(customKey){
        case '0': playDTMF(0, duration); break;
        case '1': playDTMF(1, duration); break;
        case '2': playDTMF(2, duration); break;
        case '3': playDTMF(3, duration); break;
        case '4': playDTMF(4, duration); break;
        case '5': playDTMF(5, duration); break;
        case '6': playDTMF(6, duration); break;
        case '7': playDTMF(7, duration); break;
        case '8': playDTMF(8, duration); break;
        case '9': playDTMF(9, duration); break;
        case '*': playDTMF(10, duration); break;
        case '#': playDTMF(11, duration); break;
        default: break;
      }
  }
